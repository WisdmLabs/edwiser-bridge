...
class EBPaymentManager
{
    ...
    {
        if (array_key_exists('eb', $_wp->query_vars)
            && $_wp->query_vars['eb'] == 'paypal-notify') {
     ...
     */
    protected function checkArrayValueSet($var, $value, $default = '')
    {
        if (isset($var)) {
            return $value;
        }
    ...
    public static function takeCourseButton($course_id)
    {
        ...
        $course_price_type = checkArrayValueSet(
        ...
        // }
        $course_price = checkArrayValueSet(
        ...
        // }
        $closed_button_url = checkArrayValueSet(
        ...
        $paypal_email = checkArrayValueSet(
        ...
        // }
        $paypal_currency = checkArrayValueSet(
        ...
        // }
        $paypal_country = checkArrayValueSet(
        ...
        $paypal_returnurl = checkArrayValueSet(
        ...
        // }
        $paypal_notifyurl = checkArrayValueSet(
        ...
        // }
        $paypal_sandbox = checkArrayValueSet(
        ...
        if (!is_user_logged_in() && $course_price_type == 'closed') {
            ...
            $login_url = wdmUserAccountUrl('?redirect_to='.get_permalink($course_id));
        ...
        if (!empty($course_price_type)) {
            ...
            && empty($course_price))) { //free course button
            ...
            && $course_price_type == 'paid') { //paid course button
