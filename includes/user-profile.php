...
if (!empty($enrolled_courses)) {
    foreach ($enrolled_courses as $key => $course) {
        ...
        echo EBPaymentManager::access_course_button($course->ID);
        echo '</div>';
    }
} else {
        echo '<p class="eb-no-course">Looks like you are not enrolled in any course,
        get your first course <a href="'.site_url("/courses").'">Here</a></p>';
}
    ?>
		</div>
	</section>
