...
class EB_Template_Loader {
	 ...
	 * @return void
	 */
	function wp_get_template_part( $slug, $name = '' ) {
		$template = '';
	 ...
	 * @return void
	 */
	function wp_get_template( $template_name, $args = array(), $template_path = '', $default_path = '' ) {
	 ...
	 * @return string
	 */
	function wp_locate_template( $template_name, $template_path = '', $default_path = '' ) {
		if ( ! $template_path ) {
