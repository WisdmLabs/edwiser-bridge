...
<p><?php printf( __( "Thanks for creating an account on %s. Your username is <strong>%s</strong>.", 'eb-textdomain' ), get_bloginfo( 'name' ), $args['username'] ); ?></p>

<p><?php printf( __( "Your password has been automatically generated: <strong>%s</strong>", 'eb-textdomain' ), $args['password'] ); ?></p>
