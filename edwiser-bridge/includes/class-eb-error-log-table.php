...
if ( ! class_exists( '\app\wisdmlabs\edwiserBridge\Eb_Error_Log_Table' ) ) {

	/**
	 * Custom list table.
	 */
	class Eb_Error_Log_Table extends \WP_List_Table {
		...
		public function bpGetTable( $post_data, $search_text, $current_page ) {
			...
			$table_data    = apply_filters( 'eb_error_logs_table_data', $tbl_records );
			$total_records = count( $error_logs );
			return array(
