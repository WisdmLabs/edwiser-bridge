	...
	public function eb_admin_remui_demo_notice() {
		...
		if ( ! get_user_meta( $user_id, 'eb_admin_remui_demo_notice_dismissed' ) ) {
			...
			<div class="notice  eb_admin_remui_demo_notice">
				<a style="text-decoration:none;" target="_blank" href="https://demo.tryremui.edwiser.org/schoolv2/?utm_source=remui4.0-launch-bridge-thankyoupage&utm_medium=remui4.0-launch-bridge-thankyoupage-bannerctaclicks&utm_campaign=remui-4.0-launch">
