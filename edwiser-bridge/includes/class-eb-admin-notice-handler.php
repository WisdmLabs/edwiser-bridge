...
class Eb_Admin_Notice_Handler {
	...
	public function eb_get_mdl_plugin_info() {
		...
		if ( is_wp_error( $response ) ) {
			...
			if ( isset( $body->plugin_name ) && isset( $body->version ) && 0 === version_compare( '2.0.6', $body->version ) ) {
				$status = 1;
			}
		} else {
			$status = 0;
				...
				echo '  <div class="notice  eb_admin_update_notice_message_cont">
							<div class="eb_admin_update_notice_message">
								...
								<div class="eb_update_notice_content">
									...
									<a href="https://edwiser.org/wp-content/uploads/edd/2021/03/edwiserbridgemoodle_2.0.6.zip">' . esc_html__( ' Click here ', 'eb-textdomain' ) . '</a>
