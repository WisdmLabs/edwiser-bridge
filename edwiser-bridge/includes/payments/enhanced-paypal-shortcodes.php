	...
	function eb_enhanced_paypal_shortcode( $atts ) {
		...
		switch ( $atts['type'] ) {
			...
			<input type="hidden" name="amount" value="' . $atts['amount'] . '">';
				...
				class="wdm-btn eb_primary_btn eb-paid-course button ast-button" id="eb_course_payment_button">';
			...
			width="1" height="1">';
				...
				$code .= '<input type="submit" value="' . esc_html__( 'Take this Course', 'edw' ) . '" class="wdm-btn eb_primary_btn button ast-button eb-paid-course button"
			...
			<input type="hidden" name="item_name" value="' . $atts['name'] . '">';
				...
				$code .= '<input type="submit" value="' . esc_html__( 'Take this Course', 'edw' ) . '" class="wdm-btn eb_primary_btn eb-paid-course button ast-button"
				id="eb_course_payment_button">';
