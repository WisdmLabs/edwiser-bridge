		...
		if ( is_numeric( $course_id ) ) {
			...
			if ( '' !== $moodle_course_id ) {
				...
				if ( empty( $access_course_url ) ) {
					...
					<a class="wdm-btn eb_primary_btn button" href="' . $access_course_url . '" id="wdm-btn">' .
			...
			if ( 'eb_course' === $course->post_type ) {
				...
				if ( ! is_user_logged_in() && 'closed' === $course_price_type ) {
					...
					if ( ! empty( $closed_button_url ) ) {
						...
						<a class="wdm-btn eb_primary_btn button" href="' . $closed_button_url . '" id="wdm-btn">' .
					...
					$take_course_button = '<div class="eb_join_button">
					<a class="wdm-btn eb_primary_btn button" href="' . $login_url . '" id="wdm-btn">' .
					esc_html__( 'Take this Course', 'eb-textdomain' ) . '</a></div>';
					...
					if ( ! empty( $course_price_type ) ) {
						if ( 'closed' === $course_price_type ) { // closed course button.
							...
							$take_course_button = '<div class="eb_join_button"><form method="post">
											...
											name="course_join" class="wdm-btn eb_primary_btn button" id="wdm-btn">
