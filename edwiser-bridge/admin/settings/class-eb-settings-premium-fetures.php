		...
		public function output() {
			...
			<div class='ebpf-wrap'>
				<div class='ebpf-header'>
					...
					<div class='ebpf-sub-title'>with the Edwiser Bridge bundle.</div>
					<a href="https://bit.ly/2NAJ7OW" target="_blank" class="ebpf-hbtn">Upgrade to Edwiser Bridge Bundle</a>
				...
				<div class="ebpf-footer">
					...
					<div class="ebpf-fcontent">
						<h3>Increase profits by automated course selling with<br/>Edwiser Bridge Bundle</h3>
