			...
			<div id="eb_get_license_key_dialog" style="display:none;">
				<ul>
					...
					<li class="eb_buy_license">
						<?php esc_html_e( 'If you wish to purchase Edwiser E-Commerce Suite then click here', 'eb-textdomain' ); ?>
					...
					<li class="eb_upgrade_license">
						<?php esc_html_e( 'If you already own one of the extensions, then click here to upgrade to Edwiser E-Commerce Suite', 'eb-textdomain' ); ?>
