                    ...
                    <div class="eb-pro-plugin-card <?php echo $this->bridge_pro ? '' : 'eb-pro-plugin-not-active' ; ?>">
                        ...
                        if ( ! $this->bridge_pro ) {
                            ...
                            <div class="eb-pro-license-not-active-overlay">
                                <div class="eb-pro-license-not-active-content">
                                    <?php echo sprintf( __( 'To access the Edwiser Bridge PRO features, please activate the license key from the %s tab', 'edwiser-bridge' ), '<a class="eb-pro-license-not-active-link" href="' . admin_url( 'admin.php?page=eb-settings&tab=licensing' ) . '">“License”</a>'); ?>
                                </div>
                            </div>
                            <?php
                        }
                        ...
                        <div class="eb-pro-plugin-card-footer">
                            ...
                            if ( $this->is_plugin_active($key) ) {
                                ?>
                                <a class="eb-pro-plugin-setting"  href="<?php echo esc_attr( $plugin['setting_url'] ); ?>">
    ...
    <div class="eb_table" >
        ...
        if ( ! is_plugin_active( 'edwiser-bridge-pro/edwiser-bridge-pro.php' ) ) {
            ...
            <div class="eb-pro-upgrade-plugin-notice">
                ...
                <div class="eb-pro-upgrade-plugin-notice-content">
                    <p><?php echo sprintf ( __( 'Based on your %s it seems that you have purchased only the above mentioned Edwiser Bridge Add-on plugin(s). To get access to all the Edwiser Bridge Pro feature consider %s', 'edwiser-bridge' ), '<a href="#">' . __( 'license key', 'edwiser-bridge' ) . '</a>', '<a href="#">' . __( 'Upgrading to Pro', 'edwiser-bridge' ) . '</a>' ); ?></p>
                    <p><a href="#"><?php _e( 'Refer here', 'edwiser-bridge' ); ?></a><?php _e( ' if you like to learn more about the Edwiser Bridge Pro', 'edwiser-bridge' ) ?></p>
                </div>
            </div>
            <?php
