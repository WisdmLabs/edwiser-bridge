...
<section id="primary" class="content-area" style="overflow:auto; padding:15px;">
    <main id="main" class="site-main" role="main">
        ...
        $plugin_template_loader = new app\wisdmlabs\edwiserBridge\EbTemplateLoader(app\wisdmlabs\edwiserBridge\edwiserBridgeInstance()->getPluginName(), app\wisdmlabs\edwiserBridge\edwiserBridgeInstance()->getVersion());
        ?>
