...
<form class="eb_filter_and_sorting" method="get">
	...
	<div class='eb_archive_sort'>
		...
		<select name="eb_category_sort" id="eb_category_sort" class="" >
			<option value="eb_archive_sort_a_z" <?php selected( $sorting, 'eb_archive_sort_a_z' ); ?>><?php echo esc_html_e( 'Default A to Z', 'eb_textdomain' ); ?></option>
			<option value="eb_archive_sort_z_a" <?php selected( $sorting, 'eb_archive_sort_z_a' ); ?>><?php echo esc_html_e( 'Sort Z to A', 'eb_textdomain' ); ?></option>
			...
			<option value="eb_archive_oldest" <?php selected( $sorting, 'eb_archive_oldest' ); ?>><?php echo esc_html_e( 'Sort by oldest', 'eb_textdomain' ); ?></option>
		</select>
	</div>
</form>
