...
$first_name  = get_arr_value( $_POST, 'first_name', $current_user->first_name );
$last_name   = get_arr_value( $_POST, 'last_name', $current_user->last_name );
$nickname    = get_arr_value( $_POST, 'nickname', $current_user->nickname );
$email       = get_arr_value( $_POST, 'email', $current_user->user_email );
$description = get_arr_value( $_POST, 'description', $current_user->description );
$city        = get_arr_value( $_POST, 'city', $current_user->city );
$country     = get_arr_value( $_POST, 'country', $current_user->country );
?>
