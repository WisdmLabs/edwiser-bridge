    ...
    if (isset($_GET['eb_action']) && $_GET['eb_action'] === 'edit-profile') {
        ...
        <section class="eb-user-courses">
            <div class="course-heading" >
                <span><?php _e('S.No.', 'eb-textdomain'); ?></span>
                <span><?php _e('Enrolled Courses', 'eb-textdomain'); ?></span>
            </div>
            <div class="eb-course-data">
                ...
                if (!empty($enrolled_courses)) {
                    ...
                    <p class="eb-no-course">
                        <?php
                        printf(
                                __('Looks like you are not enrolled in any course, get your first course %s', 'eb-textdomain'), '<a href="' . esc_url(site_url('/courses')) . '">' . __('here', 'eb-textdomain') . '</a>.'
                        );
                        ?>
                    </p>
                    <?php
