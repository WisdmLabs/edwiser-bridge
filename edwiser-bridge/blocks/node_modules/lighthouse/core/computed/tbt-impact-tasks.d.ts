...
declare const TBTImpactTasksComputed: typeof TBTImpactTasks & {
    request: (dependencies: import("../index.js").Artifacts.MetricComputationDataInput, context: LH.Artifacts.ComputedContext) => ReturnType<typeof TBTImpactTasks.compute_>;
};
