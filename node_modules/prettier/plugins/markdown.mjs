...
`,Dr="	",Ye=" ",BD="~",Ju="`",qD=3,TD=4;function SD(e,r,n){var t=this,a=t.options.gfm,i=r.length+1,u=0,o="",s,l,c,f,D,h,p,d,m,g,x,F,B;if(a){for(;u<i&&(c=r.charAt(u),!(c!==Ye&&c!==Dr));)o+=c,u++;if(F=u,c=r.charAt(u),!(c!==BD&&c!==Ju)){for(u++,l=c,s=1,o+=c;u<i&&(c=r.charAt(u),c===l);)o+=c,s++,u++;if(!(s<qD)){for(;u<i&&(c=r.charAt(u),!(c!==Ye&&c!==Dr));)o+=c,u++;for(f="",p="";u<i&&(c=r.charAt(u),!(c===Vr||l===Ju&&c===l));)c===Ye||c===Dr?p+=c:(f+=p+c,p=""),u++;if(c=r.charAt(u),!(c&&c!==Vr)){if(n)return!0;B=e.now(),B.column+=o.length,B.offset+=o.length,o+=f,f=t.decode.raw(t.unescape(f),B),p&&(o+=p),p="",g="",x="",d="",m="";for(var b=!0;u<i;){if(c=r.charAt(u),d+=g,m+=x,g="",x="",c!==Vr){d+=c,x+=c,u++;continue}for(b?(o+=c,b=!1):(g+=c,x+=c),p="",u++;u<i&&(c=r.charAt(u),c===Ye);)p+=c,u++;if(g+=p,x+=p.slice(F),!(p.length>=TD)){for(p="";u<i&&(c=r.charAt(u),c===l);)p+=c,u++;if(g+=p,x+=p,!(p.length<s)){for(p="";u<i&&(c=r.charAt(u),!(c!==Ye&&c!==Dr));)g+=c,x+=c,u++;if(!c||c===Vr)break}}}for(o+=d+g,u=-1,i=f.length;++u<i;)if(c=f.charAt(u),c===Ye||c===Dr)D||(D=f.slice(0,u));else if(D){h=f.slice(u);break}return e(o)({type:"code",lang:D||f||null,meta:h||null,value:m})}}}}}});var Oe=C((Ve,Zu)=>{Ve=Zu.exports=LD;function LD(e){return e.trim?e.trim():Ve.right(Ve.left(e))}Ve.left=function(e){return e.trimLeft?e.trimLeft():e.replace(/^\s\s*/,"")};Ve.right=function(e){if(e.trimRight)return e.trimRight();for(var r=/\s/,n=e.length;r.test(e.charAt(--n)););return e.slice(0,n+1)}});var jr=C((fF,ea)=>{"use strict";ea.exports=PD;function PD(e,r,n,t){for(var a=e.length,i=-1,u,o;++i<a;)if(u=e[i],o=u[1]||{},!(o.pedantic!==void 0&&o.pedantic!==n.options.pedantic)&&!(o.commonmark!==void 0&&o.commonmark!==n.options.commonmark)&&r[u[0]].apply(n,t))return!0;return!1}});var ia=C((DF,na)=>{"use strict";var _D=Oe(),OD=jr();na.exports=ID;var Rt=`
